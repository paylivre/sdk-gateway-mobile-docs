...
```groovy title=./settings.gradle lineNumbers=true highlight={6-7}
// ... other configs
...
```groovy title=./build.gradle lineNumbers=true highlight={5-6}
// ... other configs
allprojects {
    repositories {
      // ... other repositories
...
dependencies {
  // ... other dependencies
  implementation 'com.github.neijrdev:sdk-gateway-android:1.0.6'
}
```
